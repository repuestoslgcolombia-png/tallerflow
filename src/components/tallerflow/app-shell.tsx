...
// ============== SHELL PRINCIPAL ==============
// Layout de la app autenticada (sidebar + header + vista activa).
// El guard de sesión (auth-guard) decide si este shell se renderiza.
...
// Imports al final para evitar ciclos con el store en SSR (patrón del proyecto)
